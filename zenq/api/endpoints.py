                ...
                with output:
                    ...
                    for index, row in unique_customers.iterrows():
                        ...
                        try:
                            ...
                            print(f'Successfully inserted location: {customer_id}, {gender}')
                        except IntegrityError:
                            print(f'Customer {customer_id}, {gender} already exists in the table')
                self.engine.dispose()
            ...
            with output:
                ...
                for idx, (index, row) in enumerate(self.df.iterrows()):
                    ...
                    try:
                        ...
                        self.session.commit()
                        print(f'Successfully inserted facts for customer {customer_id}')
